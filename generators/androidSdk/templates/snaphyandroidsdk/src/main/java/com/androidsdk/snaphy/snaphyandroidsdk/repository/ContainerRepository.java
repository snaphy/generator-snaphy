...
public class ContainerRepository extends ModelRepository<Container> {
    ...
    public RestContract createContract() {
        RestContract contract = super.createContract();
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "ALL"), "container.getSchema");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/save", "ALL"), "container.save");
