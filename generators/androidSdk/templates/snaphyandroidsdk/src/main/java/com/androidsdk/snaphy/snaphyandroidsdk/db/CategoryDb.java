...
public class CategoryDb{
  ...
  public CategoryDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final Category modelData ){
      new Thread(new Runnable(){
        @Override
        public void run(){
          SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
    ...
    public void update__db(final String id,   final Category modelData) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
