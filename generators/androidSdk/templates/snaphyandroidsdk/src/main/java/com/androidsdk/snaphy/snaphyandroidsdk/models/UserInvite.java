...
public class UserInvite extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      UserInviteRepository lowercaseFirstLetterRepository = (UserInviteRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(hospitalUser == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = userInviteRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__hospitalUser( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<HospitalUser> callback) {
                                        ...
                                        //Define methods here..
                                        final UserInviteRepository  userInviteRepo = restAdapter.createRepository(UserInviteRepository.class);
                                        ...
                                        userInviteRepo.get__hospitalUser( (String)that.getId(), refresh,  new ObjectCallback<HospitalUser> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__hospital( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Hospital> callback) {
                                        ...
                                        userInviteRepo.get__hospital( (String)that.getId(), refresh,  new ObjectCallback<Hospital> (){
