...
public class Recommendation extends Model {
    ...
    public Recommendation (){
        that = this;
                ...
                public void setIsRecommended(boolean isRecommended){
                    ...
                    //Update hashMap value..
                    hashMap.put("isRecommended", isRecommended);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      RecommendationRepository lowercaseFirstLetterRepository = (RecommendationRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        RecommendationRepository recommendationRepository = (RecommendationRepository) getRepository();

                                        SnaphyRestAdapter restAdapter = recommendationRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final RecommendationRepository  recommendationRepo = restAdapter.createRepository(RecommendationRepository.class);
                                        ...
                                        recommendationRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__product( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        recommendationRepo.get__product( (String)that.getId(), refresh,  new ObjectCallback<Product> (){
