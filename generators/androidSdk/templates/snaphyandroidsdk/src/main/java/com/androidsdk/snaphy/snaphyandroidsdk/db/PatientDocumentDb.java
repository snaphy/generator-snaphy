...
public class PatientDocumentDb{
  ...
  public PatientDocumentDb(Context context, String DATABASE_NAME, SnaphyRestAdapter restAdapter){
    ...
    public ContentValues getContentValues(PatientDocument _modelData){
      ContentValues values = new ContentValues();
                       
                                                            String documentData = "";
                        if(_modelData.getDocument() != null){
                          GsonBuilder gsonBuilder = new GsonBuilder();
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                          documentData = gson.toJson(_modelData.getDocument(), HashMap.class);
                          values.put("`document`", documentData);
                        }
                        ...
                        if(_modelData.getUpdated() != null){
                          ...
                          values.put("`updated`", updatedData);
                                                            ...
                                                            String tagData = "";
                        if(_modelData.getTag() != null){
                          tagData = _modelData.getTag().toString();
                          values.put("`tag`", tagData);
                        }
                                  
                                
                                                            String backupPatientIdData = "";
                        if(_modelData.getBackupPatientId() != null){
                          backupPatientIdData = _modelData.getBackupPatientId().toString();
                          values.put("`backupPatientId`", backupPatientIdData);
                        }
    ...
    // Getting single c
    public   PatientDocument get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("PatientDocument", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    if (hashMap != null) {
                        PatientDocumentRepository repo = restAdapter.createRepository(PatientDocumentRepository.class);
                        repo.addStorage(context);
                        return (PatientDocument)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   PatientDocument get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("`PatientDocument`", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(0) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           documentData = gson.fromJson(cursor.getString(0), Map.class);
                          if(documentData != null){
                            documentData = (Map<String, Object>)documentData;
                        ...
                        if(cursor.getString(3) != null){
                          tagData = cursor.getString(3);
                          if(tagData != null){
                            tagData = (String)tagData;
                            hashMap.put("tag", tagData);
                          }
                        }
                        ...
                        if(cursor.getString(4) != null){
                          backupPatientIdData = cursor.getString(4);
                          if(backupPatientIdData != null){
                            backupPatientIdData = (String)backupPatientIdData;
                            hashMap.put("backupPatientId", backupPatientIdData);
                          }
                        }
                        ...
                        if(cursor.getString(8) != null){
                          hospitalIdData = cursor.getString(8);
    ...
    public void upsert__db(String id, PatientDocument model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<PatientDocument>  getAll__db() {
        DataList<PatientDocument> modelList = new DataList<PatientDocument>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `PatientDocument`";
        ...
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            ...
            do {
                ...
                if(hashMap != null){
                    PatientDocumentRepository repo = restAdapter.createRepository(PatientDocumentRepository.class);
                    repo.addStorage(context);
                    modelList.add((PatientDocument)repo.createObject(hashMap));
                }
     ...
     * @return
     */
    public LazyList<PatientDocument> getAll__lazy(final int limit, final int skip, ObjectCallback<PatientDocument> callback, final GetUpdatedQuery getUpdatedQuery, final OnParseCursor onParseCursor) {


        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();

        final PatientDocumentRepository repo = restAdapter.createRepository(PatientDocumentRepository.class);
        repo.addStorage(context);
        return new LazyList<>(db, new LazyList.ItemFactory<PatientDocument>() {
            @Override
            public PatientDocument create(Cursor cursor, int index) {
                PatientDocument data;
                cursor.moveToPosition(index);
                HashMap<String, Object> hashMap = onParseCursor.parseCursor(cursor);
                data = (PatientDocument)repo.createObject(hashMap);
                return data;
            }
            ...
            public String getUpdateQuery() {
                ...
                String selectQuery;
                if(orderBy != null){
                    selectQuery = "SELECT  * FROM `PatientDocument` " + whereQuery  + " ORDER BY " + orderBy ;
                    if(limit != 0){
                        // Select All Query
                    ...
                    if(limit != 0){
                        // Select All Query
                        selectQuery = "SELECT  * FROM PatientDocument " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
                    }else{
                        selectQuery = "SELECT  * FROM PatientDocument " + whereQuery  + " LIMIT -1 OFFSET " + skip;
                    }
                }
    ...
    public PatientDocument get__db(String id, OnParseCursor onParseCursor){
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("PatientDocument", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
    ...
    public DataList<PatientDocument>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    // Getting All Data where and sort column according to date wise..
    public DataList<PatientDocument>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<PatientDocument> modelList = new DataList<PatientDocument>();
    ...
    // Getting All Data where
    public DataList<PatientDocument>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `PatientDocument` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `PatientDocument` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `PatientDocument` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    // Getting All Data where
    public DataList<PatientDocument>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<PatientDocument> modelList = new DataList<PatientDocument>();
        // Select All Query
