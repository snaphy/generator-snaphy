...
public class NotificationData extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      NotificationDataRepository lowercaseFirstLetterRepository = (NotificationDataRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(city == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = notificationDataRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__city( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<City> callback) {
                                        ...
                                        //Define methods here..
                                        final NotificationDataRepository  notificationDataRepo = restAdapter.createRepository(NotificationDataRepository.class);
                                        ...
                                        notificationDataRepo.get__city( (String)that.getId(), refresh,  new ObjectCallback<City> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        notificationDataRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
