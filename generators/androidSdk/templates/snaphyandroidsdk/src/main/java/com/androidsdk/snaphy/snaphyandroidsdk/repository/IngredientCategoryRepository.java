...
public class IngredientCategoryRepository extends ModelRepository<IngredientCategory> {
    ...
    public RestContract createContract() {
        RestContract contract = super.createContract();
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "DEL"), "IngredientCategory.deleteById");
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/change-stream", "POST"), "IngredientCategory.createChangeStream");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "ALL"), "IngredientCategory.getSchema");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/save", "ALL"), "IngredientCategory.save");
        ...
        return contract;
            ...
            public void prototype.updateAttributes(  String id,  HashMap<String, Object> data, final ObjectCallback<IngredientCategory> callback){
