...
public class Wishlist extends Model {
    ...
    public Wishlist (){
        that = this;
                ...
                public void setEstimatedPrice(double estimatedPrice){
                    ...
                    //Update hashMap value..
                    hashMap.put("estimatedPrice", estimatedPrice);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      WishlistRepository lowercaseFirstLetterRepository = (WishlistRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        WishlistRepository wishlistRepository = (WishlistRepository) getRepository();

                                        SnaphyRestAdapter restAdapter = wishlistRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__product( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        wishlistRepo.get__product( (String)that.getId(), refresh,  new ObjectCallback<Product> (){
