...
public class PatientDocument extends Model {
    ...
    public PatientDocument (){
        that = this;
                ...
                private String backupPatientId;
                /* Adding Getter and Setter methods */
                public String getBackupPatientId(){
                    return backupPatientId;
                }

                /* Adding Getter and Setter methods */
                public void setBackupPatientId(String backupPatientId){
                    this.backupPatientId = backupPatientId;
                    //Update hashMap value..
                    hashMap.put("backupPatientId", backupPatientId);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      PatientDocumentRepository lowercaseFirstLetterRepository = (PatientDocumentRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(patient == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = patientDocumentRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__patient( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Patient> callback) {
                                        ...
                                        //Define methods here..
                                        final PatientDocumentRepository  patientDocumentRepo = restAdapter.createRepository(PatientDocumentRepository.class);
                                        ...
                                        patientDocumentRepo.get__patient( (String)that.getId(), refresh,  new ObjectCallback<Patient> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__patientGroup( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<PatientGroup> callback) {
                                        ...
                                        patientDocumentRepo.get__patientGroup( (String)that.getId(), refresh,  new ObjectCallback<PatientGroup> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__hospital( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Hospital> callback) {
                                        ...
                                        patientDocumentRepo.get__hospital( (String)that.getId(), refresh,  new ObjectCallback<Hospital> (){
