...
public class Blog extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      BlogRepository lowercaseFirstLetterRepository = (BlogRepository) getRepository();
			...
			try{
				//Adding database method for fetching from relation if not present..
		                if(school == null){
		                  ...
		                  RestAdapter restAdapter = blogRepository.getRestAdapter();
		                  if(restAdapter != null){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__school( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<School> callback) {
                                        ...
                                        //Define methods here..
                                        final BlogRepository  blogRepo = restAdapter.createRepository(BlogRepository.class);
                                        ...
                                        blogRepo.get__school( (String)that.getId(), refresh,  new ObjectCallback<School> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__admin( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Admin> callback) {
                                        ...
                                        blogRepo.get__admin( (String)that.getId(), refresh,  new ObjectCallback<Admin> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__teacher( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Teacher> callback) {
                                        ...
                                        blogRepo.get__teacher( (String)that.getId(), refresh,  new ObjectCallback<Teacher> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__student( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Student> callback) {
                                        ...
                                        blogRepo.get__student( (String)that.getId(), refresh,  new ObjectCallback<Student> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__parent( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Parent> callback) {
                                        ...
                                        blogRepo.get__parent( (String)that.getId(), refresh,  new ObjectCallback<Parent> (){
