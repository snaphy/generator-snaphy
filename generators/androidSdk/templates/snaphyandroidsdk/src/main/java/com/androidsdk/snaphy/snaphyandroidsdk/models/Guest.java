...
public class Guest extends User {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      GuestRepository lowercaseFirstLetterRepository = (GuestRepository) getRepository();
			...
			try{
				//Adding database method for fetching from relation if not present..
		                if(school == null){
		                  ...
		                  RestAdapter restAdapter = guestRepository.getRestAdapter();
		                  if(restAdapter != null){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__school( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<School> callback) {
                                        ...
                                        //Define methods here..
                                        final GuestRepository  guestRepo = restAdapter.createRepository(GuestRepository.class);
                                        ...
                                        guestRepo.get__school( (String)that.getId(), refresh,  new ObjectCallback<School> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__admins( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Admin> callback) {
                                        ...
                                        guestRepo.get__admins( (String)that.getId(), refresh,  new ObjectCallback<Admin> (){
                                    ...
                                    public void create__admins( Admin data,  RestAdapter restAdapter, final ObjectCallback<Admin> callback) {
                                        ...
                                        guestRepo.create__admins( (String)that.getId(), data.convertMap(),  new ObjectCallback<Admin> (){
                                    ...
                                    public void update__admins( Admin data,  RestAdapter restAdapter, final ObjectCallback<Admin> callback) {
                                        ...
                                        guestRepo.update__admins( (String)that.getId(), data.convertMap(),  new ObjectCallback<Admin> (){
                                    ...
                                    public void destroy__admins( RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        guestRepo.destroy__admins( (String)that.getId(),  new VoidCallback (){
