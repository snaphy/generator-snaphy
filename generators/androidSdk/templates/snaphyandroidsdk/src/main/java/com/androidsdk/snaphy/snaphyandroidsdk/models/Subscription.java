...
public class Subscription extends Model {
    ...
    public Subscription (){
        that = this;
                ...
                private DataList<Double> dates;
                /* Adding Getter and Setter methods */
                public DataList<Double> getDates(){
                    return dates;
                }

                /* Adding Getter and Setter methods */
                public void setDates(DataList<Double> dates){
                    this.dates = dates;
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      SubscriptionRepository lowercaseFirstLetterRepository = (SubscriptionRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = subscriptionRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final SubscriptionRepository  subscriptionRepo = restAdapter.createRepository(SubscriptionRepository.class);
                                        ...
                                        subscriptionRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__product( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        subscriptionRepo.get__product( (String)that.getId(), refresh,  new ObjectCallback<Product> (){
