...
public class DistrictDb{
  ...
  public DistrictDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<District>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                ...
                selectQuery = "SELECT  * FROM District " + whereQuery  + " OFFSET " + skip;
            }
        }
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                ...
                countQuery = "SELECT  * FROM `District` " + whereQuery + " OFFSET " + skip;
            }
        }
