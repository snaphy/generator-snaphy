    ...
    public Transaction (){
        that = this;
                ...
                public void setPayUTransactionId(String payUTransactionId){
                    ...
                    //Update hashMap value..
                    hashMap.put("payUTransactionId", payUTransactionId);
                }
                ...
                public void setBankIFSCCode(String bankIFSCCode){
                    ...
                    //Update hashMap value..
                    hashMap.put("bankIFSCCode", bankIFSCCode);
                }
                ...
                public void setPaymentPercent(double paymentPercent){
                    ...
                    //Update hashMap value..
                    hashMap.put("paymentPercent", paymentPercent);
                }
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = transactionRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        transactionRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
