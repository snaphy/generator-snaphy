...
public class NewsRead extends Model {
    ...
    public NewsRead (){
        that = this;
                ...
                private double readerId;
                /* Adding Getter and Setter methods */
                public double getReaderId(){
                    return readerId;
                }

                /* Adding Getter and Setter methods */
                public void setReaderId(double readerId){
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      NewsReadRepository lowercaseFirstLetterRepository = (NewsReadRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(appUser == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = newsReadRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__appUser( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<AppUser> callback) {
                                        ...
                                        //Define methods here..
                                        final NewsReadRepository  newsReadRepo = restAdapter.createRepository(NewsReadRepository.class);
                                        ...
                                        newsReadRepo.get__appUser( (String)that.getId(), refresh,  new ObjectCallback<AppUser> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__news( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<News> callback) {
                                        ...
                                        newsReadRepo.get__news( (String)that.getId(), refresh,  new ObjectCallback<News> (){
