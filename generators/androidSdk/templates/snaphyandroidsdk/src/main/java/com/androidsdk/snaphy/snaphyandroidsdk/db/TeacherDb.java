...
public class TeacherDb{
  ...
  public TeacherDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void insert__db (final String id, final Teacher modelData) {
    ...
    public ContentValues getContentValues(Teacher modelData){
    ...
    // Getting single c
    public   Teacher get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Teacher", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    //db.close(); // Closing database connection
                    if (hashMap != null) {
                        TeacherRepository repo = restAdapter.createRepository(TeacherRepository.class);
                        repo.addStorage(context);
                        return (Teacher)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   Teacher get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Teacher", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    public void upsert__db(String id, Teacher model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<Teacher>  getAll__db() {
        DataList<Teacher> modelList = new DataList<Teacher>();
        // Select All Query
        ...
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            return (DataList<Teacher>) modelList;
        }else{
            do {
                ...
                if(hashMap != null){
                    TeacherRepository repo = restAdapter.createRepository(TeacherRepository.class);
                    repo.addStorage(context);
                    modelList.add((Teacher)repo.createObject(hashMap));
                }
    ...
    public DataList<Teacher>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    public DataList<Teacher>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Teacher> modelList = new DataList<Teacher>();
        String whereQuery = getWhereQuery(whereKeyValue);
        String selectQuery;
        if(orderBy != null){
            selectQuery = "SELECT  * FROM Teacher " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Teacher " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Teacher " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Teacher>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM Teacher " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM Teacher " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM Teacher " + whereQuery;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // updating row
                db.update("Teacher", values, "_DATA_UPDATED = 1 AND " + where, null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                db.beginTransaction();
                String where = getWhere(whereKeyValue);
                db.delete("Teacher", "_DATA_UPDATED = 0 AND " + where , null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    // Getting All Data where
    public DataList<Teacher>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<Teacher> modelList = new DataList<Teacher>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `Teacher` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
    ...
    public int count__db(String whereKey, String whereKeyValue){
        String countQuery = "SELECT  * FROM `Teacher` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
        Cursor cursor = db.rawQuery(countQuery, null);
        int count = cursor.getCount();
        cursor.close();
    ...
    public void checkOldData__db(final String whereKey, final String whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                values.put("_DATA_UPDATED", 0);
                // updating row
                db.update("Teacher", values, "_DATA_UPDATED = 1 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db(final String whereKey, final String whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
                db.beginTransaction();
                db.delete("Teacher", "_DATA_UPDATED = 0 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void update__db(final String id,   final Teacher modelData) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
    ...
    public void checkOldData__db() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                values.put("_DATA_UPDATED", 0);
                // updating row
                db.update("Teacher", values, "_DATA_UPDATED = 1", null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db() {
      new Thread(new Runnable() {
            ...
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
                db.beginTransaction();
                db.delete("Teacher", "_DATA_UPDATED = 0", null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
