...
public class HospitalUserSettingDb{
  ...
  public HospitalUserSettingDb(Context context, String DATABASE_NAME, SnaphyRestAdapter restAdapter){
    //super(context, DATABASE_NAME, null, DATABASE_VERSION);
    this.context = context;
    this.restAdapter = restAdapter;
    TABLE = "HospitalUserSetting";
    ...
    public void insert__db (final String id, final HospitalUserSetting _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      // Inserting Row
      ContentValues values = getContentValues(_modelData);
      db.insert("`HospitalUserSetting`", null, values);
    }
    ...
    public ContentValues getContentValues(HospitalUserSetting _modelData){
      ContentValues values = new ContentValues();
                        ...
                        if(_modelData.getUpdated() != null){
                          ...
                          values.put("`updated`", updatedData);
                                                            ...
                                                            String userRoleData = "";
                        if(_modelData.getUserRole() != null){
                          userRoleData = _modelData.getUserRole().toString();
                          values.put("`userRole`", userRoleData);
                        }
    ...
    // Getting single c
    public   HospitalUserSetting get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("HospitalUserSetting", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    if (hashMap != null) {
                        HospitalUserSettingRepository repo = restAdapter.createRepository(HospitalUserSettingRepository.class);
                        repo.addStorage(context);
                        return (HospitalUserSetting)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   HospitalUserSetting get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("`HospitalUserSetting`", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(2) != null){
                          userRoleData = cursor.getString(2);
                          if(userRoleData != null){
                            userRoleData = (String)userRoleData;
                            hashMap.put("userRole", userRoleData);
                          }
                        }
                        ...
                        if(cursor.getString(5) != null){
                          ...
                          followUpFeesData = cursor.getInt(6);
                          ...
                          followUpDaysData = cursor.getInt(7);
    ...
    public void upsert__db(String id, HospitalUserSetting model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<HospitalUserSetting>  getAll__db() {
        DataList<HospitalUserSetting> modelList = new DataList<HospitalUserSetting>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `HospitalUserSetting`";

        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
        //http://www.tothenew.com/blog/sqlite-locking-and-transaction-handling-in-android/
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            return (DataList<HospitalUserSetting>) modelList;
        }else{
            do {
                ...
                if(hashMap != null){
                    HospitalUserSettingRepository repo = restAdapter.createRepository(HospitalUserSettingRepository.class);
                    repo.addStorage(context);
                    modelList.add((HospitalUserSetting)repo.createObject(hashMap));
                }
     ...
     * @return
     */
    public LazyList<HospitalUserSetting> getAll__lazy(final int limit, final int skip, ObjectCallback<HospitalUserSetting> callback, final GetUpdatedQuery getUpdatedQuery, final OnParseCursor onParseCursor) {


        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();

        final HospitalUserSettingRepository repo = restAdapter.createRepository(HospitalUserSettingRepository.class);
        repo.addStorage(context);
        return new LazyList<>(db, new LazyList.ItemFactory<HospitalUserSetting>() {
            @Override
            public HospitalUserSetting create(Cursor cursor, int index) {
                HospitalUserSetting data;
                cursor.moveToPosition(index);
                HashMap<String, Object> hashMap = onParseCursor.parseCursor(cursor);
                data = (HospitalUserSetting)repo.createObject(hashMap);
                return data;
            }
            ...
            public String getUpdateQuery() {
                ...
                String selectQuery;
                if(orderBy != null){
                    selectQuery = "SELECT  * FROM `HospitalUserSetting` " + whereQuery  + " ORDER BY " + orderBy ;
                    if(limit != 0){
                        // Select All Query
    ...
    public HospitalUserSetting get__db(String id, OnParseCursor onParseCursor){
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("HospitalUserSetting", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
    ...
    public DataList<HospitalUserSetting>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    // Getting All Data where and sort column according to date wise..
    public DataList<HospitalUserSetting>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<HospitalUserSetting> modelList = new DataList<HospitalUserSetting>();
    ...
    // Getting All Data where
    public DataList<HospitalUserSetting>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `HospitalUserSetting` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
            ...
            // updating row
            db.update("`HospitalUserSetting`", values, "_DATA_UPDATED = 1 AND " + where, null);
    }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`HospitalUserSetting`", "_DATA_UPDATED = 0 AND " + where , null);
    }
    ...
    public void delete__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`HospitalUserSetting`", where , null);
    }
    ...
    // Getting All Data where
    public DataList<HospitalUserSetting>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<HospitalUserSetting> modelList = new DataList<HospitalUserSetting>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `HospitalUserSetting` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
    ...
    public int count__db(String whereKey, String whereKeyValue){
      String countQuery = "SELECT  * FROM `HospitalUserSetting` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
      Cursor cursor = db.rawQuery(countQuery, null);
      int count = cursor.getCount();
      cursor.close();
    ...
    public void checkOldData__db(final String whereKey, final String whereKeyValue) {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`HospitalUserSetting`", values, "_DATA_UPDATED = 1 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }
    ...
    public void deleteOldData__db(final String whereKey, final String whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`HospitalUserSetting`", "_DATA_UPDATED = 0 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }


    //Update multiple data at once..
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final HospitalUserSetting _modelData ){
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
      db.update("`HospitalUserSetting`", values, where, null);
    }
    ...
    public void update__db(final String id,   final HospitalUserSetting _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`HospitalUserSetting`", values, "id = ?", new String[] { id });
    }
    ...
    public void checkOldData__db() {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`HospitalUserSetting`", values, "_DATA_UPDATED = 1", null);
    }
    ...
    public void deleteOldData__db() {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`HospitalUserSetting`", "_DATA_UPDATED = 0", null);
    }
