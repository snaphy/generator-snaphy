...
public class CityRepository extends ModelRepository<City> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers/:fk", "GET"), "City.prototype.__findById__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers/:fk", "DELETE"), "City.prototype.__destroyById__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers/:fk", "PUT"), "City.prototype.__updateById__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas/:fk", "GET"), "City.prototype.__findById__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas/:fk", "DELETE"), "City.prototype.__destroyById__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas/:fk", "PUT"), "City.prototype.__updateById__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData/:fk", "GET"), "City.prototype.__findById__notificationData");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData/:fk", "DELETE"), "City.prototype.__destroyById__notificationData");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData/:fk", "PUT"), "City.prototype.__updateById__notificationData");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers", "GET"), "City.prototype.__get__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers", "POST"), "City.prototype.__create__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers", "DELETE"), "City.prototype.__delete__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/customers/count", "GET"), "City.prototype.__count__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas", "GET"), "City.prototype.__get__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas", "POST"), "City.prototype.__create__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas", "DELETE"), "City.prototype.__delete__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/areas/count", "GET"), "City.prototype.__count__areas");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData", "GET"), "City.prototype.__get__notificationData");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData", "POST"), "City.prototype.__create__notificationData");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData", "DELETE"), "City.prototype.__delete__notificationData");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:cityId/notificationData/count", "GET"), "City.prototype.__count__notificationData");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void findById__customers(  String cityId,  String fk, final ObjectCallback<Customer> callback){
            ...
            public void destroyById__customers(  String cityId,  String fk, final VoidCallback callback){
            ...
            public void updateById__customers(  String cityId,  String fk,  Map<String,  ? extends Object> data, final ObjectCallback<Customer> callback){
            ...
            public void findById__areas(  String cityId,  String fk, final ObjectCallback<Area> callback){
            ...
            public void destroyById__areas(  String cityId,  String fk, final VoidCallback callback){
            ...
            public void updateById__areas(  String cityId,  String fk,  Map<String,  ? extends Object> data, final ObjectCallback<Area> callback){
            ...
            public void findById__notificationData(  String cityId,  String fk, final ObjectCallback<NotificationData> callback){
            ...
            public void destroyById__notificationData(  String cityId,  String fk, final VoidCallback callback){
            ...
            public void updateById__notificationData(  String cityId,  String fk,  Map<String,  ? extends Object> data, final ObjectCallback<NotificationData> callback){
            ...
            public void get__customers(  String cityId,  Map<String,  ? extends Object> filter, final DataListCallback<Customer> callback){
            ...
            public void create__customers(  String cityId,  Map<String,  ? extends Object> data, final ObjectCallback<Customer> callback){
            ...
            public void delete__customers(  String cityId, final VoidCallback callback){
            ...
            public void count__customers(  String cityId,  Map<String,  ? extends Object> where, final ObjectCallback<JSONObject>  callback ){
            ...
            public void get__areas(  String cityId,  Map<String,  ? extends Object> filter, final DataListCallback<Area> callback){
            ...
            public void create__areas(  String cityId,  Map<String,  ? extends Object> data, final ObjectCallback<Area> callback){
            ...
            public void delete__areas(  String cityId, final VoidCallback callback){
            ...
            public void count__areas(  String cityId,  Map<String,  ? extends Object> where, final ObjectCallback<JSONObject>  callback ){
            ...
            public void get__notificationData(  String cityId,  Map<String,  ? extends Object> filter, final DataListCallback<NotificationData> callback){
            ...
            public void create__notificationData(  String cityId,  Map<String,  ? extends Object> data, final ObjectCallback<NotificationData> callback){
            ...
            public void delete__notificationData(  String cityId, final VoidCallback callback){
            ...
            public void count__notificationData(  String cityId,  Map<String,  ? extends Object> where, final ObjectCallback<JSONObject>  callback ){
