...
public class DbHandler extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
                        ...
                        String CREATE_Admin_TABLE_14 = "CREATE TABLE IF NOT EXISTS `Admin` (  `added` TEXT, `updated` TEXT, `name` TEXT, `address` TEXT, `username` TEXT, `password` TEXT, `phoneNumber` TEXT, `email` TEXT, `registrationId` TEXT, `realm` TEXT, `credentials` TEXT, `challenges` TEXT, `emailVerified` TEXT, `verificationToken` TEXT, `status` TEXT, `created` TEXT, `lastUpdated` TEXT, `id` TEXT PRIMARY KEY, `schoolId` TEXT, `teacherId` TEXT, `parentId` TEXT, `guestId` TEXT, _DATA_UPDATED NUMBER )";
                        db.execSQL(CREATE_Admin_TABLE_14);


                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                        
                        String CREATE_Teacher_TABLE_15 = "CREATE TABLE IF NOT EXISTS `Teacher` (  `added` TEXT, `updated` TEXT, `name` TEXT, `username` TEXT, `email` TEXT, `password` TEXT, `phoneNumber` TEXT, `alternatePhoneNumber` TEXT, `teacherClass` TEXT, `teacherSection` TEXT, `registrationId` TEXT, `address` TEXT, `realm` TEXT, `credentials` TEXT, `challenges` TEXT, `emailVerified` TEXT, `verificationToken` TEXT, `status` TEXT, `created` TEXT, `lastUpdated` TEXT, `id` TEXT PRIMARY KEY, `schoolId` TEXT, _DATA_UPDATED NUMBER )";
