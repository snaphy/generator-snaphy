...
public class DbHandler extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
                        ...
                        String CREATE_Post_TABLE_22 = "CREATE TABLE IF NOT EXISTS `Post` (  `heading` TEXT, `description` TEXT, `added` TEXT, `postImages` TEXT, `anonymous` NUMBER, `status` TEXT, `latest` TEXT, `unsolved` TEXT, `trending` TEXT, `posted` TEXT, `saved` TEXT, `id` TEXT PRIMARY KEY, `customerId` TEXT, _DATA_UPDATED NUMBER )";
