        ...
        public void onCreate(final SQLiteDatabase db) {
            new Thread(new Runnable() {
              ...
              public void run() {
                            ...
                            String CREATE_Bill_TABLE_60 = "CREATE TABLE IF NOT EXISTS `Bill` (  `added` TEXT, `updated` TEXT, `type` TEXT, `subBillCategoryName` TEXT, `facility` TEXT, `amount` NUMBER, `description` TEXT, `id` TEXT PRIMARY KEY, `patientGroupId` TEXT, `hospitalUserId` TEXT, `hospitalId` TEXT, `patientId` TEXT, `billCategoryId` TEXT, `subBillCategoryId` TEXT, _DATA_UPDATED NUMBER )";
