...
public class CustomerRepository extends ModelRepository<Customer> {
    ...
    public RestContract createContract() {
        RestContract contract = super.createContract();
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "DEL"), "Customer.deleteById");
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/change-stream", "POST"), "Customer.createChangeStream");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "ALL"), "Customer.getSchema");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/save", "ALL"), "Customer.save");
        ...
        return contract;
            ...
            public void prototype.updateAttributes(  String id,  HashMap<String, Object> data, final ObjectCallback<Customer> callback){
