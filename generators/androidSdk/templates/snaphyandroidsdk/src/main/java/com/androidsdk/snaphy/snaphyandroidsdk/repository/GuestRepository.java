...
import android.content.Context;
import com.androidsdk.snaphy.snaphyandroidsdk.db.GuestDb;
...
public class GuestRepository extends UserRepository<Guest> {
    ...
    public Context getContext(){
        return context;
    		...
    		public Guest cachedCurrentUser;
            private Object currentUserId;
            private boolean isCurrentUserIdLoaded;

    		public Guest getCachedCurrentUser(){
    			return cachedCurrentUser;
    		}

    		public void setCachedCurrentUser(Guest user){
            ...
            public void findCurrentUser(final ObjectCallback<Guest> callback){
                ...
                this.findById((String)getCurrentUserId(), hashMap, new ObjectCallback<Guest>() {
                    @Override
                    public void onSuccess(Guest user){
                        cachedCurrentUser = user;
    ...
    public void setGuestDb(GuestDb guestDb) {
    ...
    public void addStorage(Context context){
         ...
         setGuestDb(new GuestDb(context, DATABASE_NAME, getRestAdapter()));
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens/:fk", "GET"), "Guest.prototype.__findById__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens/:fk", "DELETE"), "Guest.prototype.__destroyById__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens/:fk", "PUT"), "Guest.prototype.__updateById__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/school", "GET"), "Guest.prototype.__get__school");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/admins", "GET"), "Guest.prototype.__get__admins");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/admins", "POST"), "Guest.prototype.__create__admins");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/admins", "PUT"), "Guest.prototype.__update__admins");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/admins", "DELETE"), "Guest.prototype.__destroy__admins");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens", "GET"), "Guest.prototype.__get__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens", "POST"), "Guest.prototype.__create__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens", "DELETE"), "Guest.prototype.__delete__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId/accessTokens/count", "GET"), "Guest.prototype.__count__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "POST"), "Guest.create");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "PUT"), "Guest.upsert");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id/exists", "GET"), "Guest.exists");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "GET"), "Guest.findById");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "GET"), "Guest.find");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/findOne", "GET"), "Guest.findOne");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/update", "POST"), "Guest.updateAll");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "DELETE"), "Guest.deleteById");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/count", "GET"), "Guest.count");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:guestId", "PUT"), "Guest.prototype.updateAttributes");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/confirm", "GET"), "Guest.confirm");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/reset", "POST"), "Guest.resetPassword");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "POST"), "Guest.getSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getAbsoluteSchema", "POST"), "Guest.getAbsoluteSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getDetailSchema", "POST"), "Guest.getDetailSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getModelRelationSchema", "POST"), "Guest.getModelRelationSchema");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void findById__accessTokens(  String guestId,  String fk, final ObjectCallback<AccessToken> callback){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("guestId", guestId);
            ...
            public void destroyById__accessTokens(  String guestId,  String fk, final VoidCallback callback){
            ...
            public void updateById__accessTokens(  String guestId,  String fk,  Map<String,  ? extends Object> data, final ObjectCallback<AccessToken> callback){
            ...
            public void get__school(  String guestId,  Boolean refresh, final ObjectCallback<School> callback){
            ...
            public void get__admins(  String guestId,  Boolean refresh, final ObjectCallback<Admin> callback){
            ...
            public void create__admins(  String guestId,  Map<String,  ? extends Object> data, final ObjectCallback<Admin> callback){
            ...
            public void update__admins(  String guestId,  Map<String,  ? extends Object> data, final ObjectCallback<Admin> callback){
            ...
            public void destroy__admins(  String guestId, final VoidCallback callback){
            ...
            public void get__accessTokens(  String guestId,  Map<String,  ? extends Object> filter, final DataListCallback<AccessToken> callback){
            ...
            public void create__accessTokens(  String guestId,  Map<String,  ? extends Object> data, final ObjectCallback<AccessToken> callback){
            ...
            public void delete__accessTokens(  String guestId, final VoidCallback callback){
            ...
            public void count__accessTokens(  String guestId,  Map<String,  ? extends Object> where, final ObjectCallback<JSONObject>  callback ){
            ...
            public void create(  Map<String,  ? extends Object> data, final ObjectCallback<Guest> callback){
            ...
            public void upsert(  Map<String,  ? extends Object> data, final ObjectCallback<Guest> callback){
            ...
            public void findById(  String id,  Map<String,  ? extends Object> filter, final ObjectCallback<Guest> callback){
            ...
            public void find(  Map<String,  ? extends Object> filter, final DataListCallback<Guest> callback){
            ...
            public void findOne(  Map<String,  ? extends Object> filter, final ObjectCallback<Guest> callback){
            ...
            public void updateAttributes(  String guestId,  Map<String,  ? extends Object> data, final ObjectCallback<Guest> callback){
