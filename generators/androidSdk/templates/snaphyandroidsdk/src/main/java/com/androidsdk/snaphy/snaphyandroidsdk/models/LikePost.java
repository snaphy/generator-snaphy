...
public class LikePost extends Model {
    ...
    //Now adding relations between related models
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__post( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Post> callback) {
                                        ...
                                        //Define methods here..
                                        final LikePostRepository  likePostRepo = restAdapter.createRepository(LikePostRepository.class);
                                        ...
                                        likePostRepo.get__post( (String)that.getId(), refresh,  new ObjectCallback<Post> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        likePostRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__postSubscribers( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<PostSubscriber> callback) {
                                        ...
                                        likePostRepo.get__postSubscribers( (String)that.getId(), refresh,  new ObjectCallback<PostSubscriber> (){
                                    ...
                                    public void create__postSubscribers( PostSubscriber data,  RestAdapter restAdapter, final ObjectCallback<PostSubscriber> callback) {
                                        ...
                                        likePostRepo.create__postSubscribers( (String)that.getId(), data.convertMap(),  new ObjectCallback<PostSubscriber> (){
                                    ...
                                    public void update__postSubscribers( PostSubscriber data,  RestAdapter restAdapter, final ObjectCallback<PostSubscriber> callback) {
                                        ...
                                        likePostRepo.update__postSubscribers( (String)that.getId(), data.convertMap(),  new ObjectCallback<PostSubscriber> (){
                                    ...
                                    public void destroy__postSubscribers( RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        likePostRepo.destroy__postSubscribers( (String)that.getId(),  new VoidCallback (){
