...
public class RecentSearch extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      RecentSearchRepository lowercaseFirstLetterRepository = (RecentSearchRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = recentSearchRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final RecentSearchRepository  recentSearchRepo = restAdapter.createRepository(RecentSearchRepository.class);
                                        ...
                                        recentSearchRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
