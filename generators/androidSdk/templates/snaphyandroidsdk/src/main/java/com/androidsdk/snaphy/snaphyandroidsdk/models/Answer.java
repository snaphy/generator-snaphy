...
public class Answer extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      AnswerRepository lowercaseFirstLetterRepository = (AnswerRepository) getRepository();
			...
			try{
				//Adding database method for fetching from relation if not present..
		                if(school == null){
		                  ...
		                  RestAdapter restAdapter = answerRepository.getRestAdapter();
		                  if(restAdapter != null){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__school( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<School> callback) {
                                        ...
                                        //Define methods here..
                                        final AnswerRepository  answerRepo = restAdapter.createRepository(AnswerRepository.class);
                                        ...
                                        answerRepo.get__school( (String)that.getId(), refresh,  new ObjectCallback<School> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__admin( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Admin> callback) {
                                        ...
                                        answerRepo.get__admin( (String)that.getId(), refresh,  new ObjectCallback<Admin> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__teacher( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Teacher> callback) {
                                        ...
                                        answerRepo.get__teacher( (String)that.getId(), refresh,  new ObjectCallback<Teacher> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__student( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Student> callback) {
                                        ...
                                        answerRepo.get__student( (String)that.getId(), refresh,  new ObjectCallback<Student> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__parent( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Parent> callback) {
                                        ...
                                        answerRepo.get__parent( (String)that.getId(), refresh,  new ObjectCallback<Parent> (){
			...
			try{
				//Adding database method for fetching from relation if not present..
		                if(question == null){
		                  ...
		                  if(restAdapter != null){
		                    //Fetch locally from db
		                    question = getQuestion__db(restAdapter);
		                  }
		                }
			}catch(Exception e){
				//Ignore
                    ...
                    public void setQuestion(Map<String, Object> question) {
                        ...
                        Question question1 = questionRepository.createObject(question);
                        setQuestion(question1);
                    }

                    //Adding related model automatically in case of include statement from server..
                    public void setQuestion(HashMap<String, Object> question) {
                        //First create a dummy Repo class object for customer.
                        QuestionRepository questionRepository = new QuestionRepository();
                        Question question1 = questionRepository.createObject(question);
                        setQuestion(question1);
                    ...
                    //Adding relation method..
                    public void addRelation(Question question) {
                        that.setQuestion(question);
                    }


                    //Fetch related data from local database if present a questionId identifier as property for belongsTo
                    public Question getQuestion__db(RestAdapter restAdapter){
                      if(questionId != null){
                        QuestionRepository questionRepository = restAdapter.createRepository(QuestionRepository.class);
			  try{
				AnswerRepository lowercaseFirstLetterRepository = (AnswerRepository) getRepository();
		                  if(lowercaseFirstLetterRepository.isSTORE_LOCALLY()){
		                        Context context = lowercaseFirstLetterRepository.getContext();
		                        if(questionRepository.getDb() == null ){
		                            questionRepository.addStorage(context);
		                        }

		                        if(context != null && questionRepository.getDb() != null){
		                            questionRepository.addStorage(context);
		                            Question question = (Question) questionRepository.getDb().get__db(questionId);
		                            return question;
		                        }else{
		                            return null;
		                        }
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    //Write the method here..
                                    public void get__question( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Question> callback) {
                                        //Call the onBefore callback method..
                                        callback.onBefore();
                                        ...
                                        answerRepo.get__question( (String)that.getId(), refresh,  new ObjectCallback<Question> (){
