...
public class PatientDb{
  ...
  public PatientDb(Context context, String DATABASE_NAME, SnaphyRestAdapter restAdapter){
                    ...
                    values.put("`relatedPatients`", relatedPatientsData);
                        ...
                        if(_modelData.getAddress() != null){
                          ...
                          values.put("`address`", addressData);
                                                            ...
                                                            String aadharDataData = "";
                        if(_modelData.getAadharData() != null){
                          aadharDataData = _modelData.getAadharData().toString();
                          values.put("`aadharData`", aadharDataData);
                        }
                    ...
                    values.put("`otherAddress`", otherAddressData);
                        ...
                        if(_modelData.getPincodeNumber() != null){
                          ...
                          values.put("`pincodeNumber`", pincodeNumberData);
                                                            ...
                                                            String assignedFlagColorData = "";
                        if(_modelData.getAssignedFlagColor() != null){
                          assignedFlagColorData = _modelData.getAssignedFlagColor().toString();
                          values.put("`assignedFlagColor`", assignedFlagColorData);
                        }
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                    ...
                    if(relatedPatientsData != null){
                      ...
                      hashMap.put("relatedPatients", relatedPatientsData);
                        ...
                        if(cursor.getString(21) != null){
                          aadharDataData = cursor.getString(21);
                          if(aadharDataData != null){
                            aadharDataData = (String)aadharDataData;
                            hashMap.put("aadharData", aadharDataData);
                          }
                        }
                  ...
                  if(cursor.getString(22) != null){
                    ...
                    gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                    Gson gson = gsonBuilder.create();
                    otherAddressData = gson.fromJson(cursor.getString(22), DataList.class);
                    if(otherAddressData != null){
                      ...
                      hashMap.put("otherAddress", otherAddressData);
                        ...
                        if(cursor.getString(23) != null){
                          pincodeNumberData = cursor.getString(23);
                        ...
                        if(cursor.getString(24) != null){
                          assignedFlagColorData = cursor.getString(24);
                          if(assignedFlagColorData != null){
                            assignedFlagColorData = (String)assignedFlagColorData;
                            hashMap.put("assignedFlagColor", assignedFlagColorData);
                          }
                        }
                        ...
                        if(cursor.getString(26) != null){
                          usernameData = cursor.getString(26);
                        ...
                        if(cursor.getString(27) != null){
                          passwordData = cursor.getString(27);
                        ...
                        if(cursor.getString(28) != null){
                          credentialsData = cursor.getString(28);
                        ...
                        if(cursor.getString(29) != null){
                          challengesData = cursor.getString(29);
                        ...
                        if(cursor.getString(30) != null){
                          emailVerifiedData = cursor.getString(30);
                        ...
                        if(cursor.getString(31) != null){
                          verificationTokenData = cursor.getString(31);
                        ...
                        if(cursor.getString(32) != null){
                          createdData = cursor.getString(32);
                          if(createdData != null){
                        ...
                        if(cursor.getString(33) != null){
                          lastUpdatedData = cursor.getString(33);
                        ...
                        if(cursor.getString(35) != null){
                          mergedWithIdData = cursor.getString(35);
                        ...
                        if(cursor.getString(36) != null){
                          aadharIdData = cursor.getString(36);
                        ...
                        if(cursor.getString(37) != null){
                          stateIdData = cursor.getString(37);
                          if(stateIdData != null){
                        ...
                        if(cursor.getString(38) != null){
                          pincodeIdData = cursor.getString(38);
                        ...
                        if(cursor.getString(39) != null){
                          talukIdData = cursor.getString(39);
                          if(talukIdData != null){
                        ...
                        if(cursor.getString(40) != null){
                          districtIdData = cursor.getString(40);
     ...
     * @return
     */
    public LazyList<Patient> getAll__lazy(final int limit, final int skip, ObjectCallback<Patient> callback, final GetUpdatedQuery getUpdatedQuery, final OnParseCursor onParseCursor) {


        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();

        final PatientRepository repo = restAdapter.createRepository(PatientRepository.class);
        repo.addStorage(context);
        return new LazyList<>(db, new LazyList.ItemFactory<Patient>() {
            @Override
            public Patient create(Cursor cursor, int index) {
                Patient data;
                cursor.moveToPosition(index);
                HashMap<String, Object> hashMap = onParseCursor.parseCursor(cursor);
                data = (Patient)repo.createObject(hashMap);
                return data;
            }
    ...
    public Patient get__db(String id, OnParseCursor onParseCursor){
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Patient", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
