...
public class WelcomeMessage extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      WelcomeMessageRepository lowercaseFirstLetterRepository = (WelcomeMessageRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public ChatRoom getChatRoom() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(chatRoom == null){
                                        WelcomeMessageRepository welcomeMessageRepository = (WelcomeMessageRepository) getRepository();

                                        SnaphyRestAdapter restAdapter = welcomeMessageRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__chatRoom( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<ChatRoom> callback) {
                                        ...
                                        //Define methods here..
                                        final WelcomeMessageRepository  welcomeMessageRepo = restAdapter.createRepository(WelcomeMessageRepository.class);
                                        ...
                                        welcomeMessageRepo.get__chatRoom( (String)that.getId(), refresh,  new ObjectCallback<ChatRoom> (){
