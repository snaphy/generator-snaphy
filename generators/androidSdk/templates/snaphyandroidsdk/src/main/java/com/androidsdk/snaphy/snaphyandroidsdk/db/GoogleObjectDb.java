    ...
    public ContentValues getContentValues(GoogleObject modelData){
      ContentValues values = new ContentValues();
                        ...
                        if(modelData.getReplies() != null){
                          repliesData = new Gson().toJson(modelData.getReplies(), HashMap.class);
                        }
                                                values.put("`replies`", repliesData);
                                
                                                            String plusonersData = "";
                        if(modelData.getPlusoners() != null){
                          plusonersData = new Gson().toJson(modelData.getPlusoners(), HashMap.class);
                        }
                                                values.put("`plusoners`", plusonersData);
                                
                                  String attachmentsData = "";
                  if(modelData.getAttachments() != null){
                    attachmentsData = new Gson().toJson(modelData.getAttachments(), DataList.class);
                  }
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(1) != null){
                          repliesData = new Gson().fromJson(cursor.getString(1), Map.class);
                          if(repliesData != null){
                        ...
                        if(cursor.getString(2) != null){
                          plusonersData = new Gson().fromJson(cursor.getString(2), Map.class);
                  ...
                  if(cursor.getString(3) != null){
                    attachmentsData = new Gson().fromJson(cursor.getString(3), DataList.class);
