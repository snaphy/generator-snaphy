...
public class SnaphyNotificationDb{
  ...
  public SnaphyNotificationDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void insert__db (final String id, final SnaphyNotification modelData) {
    ...
    public ContentValues getContentValues(SnaphyNotification modelData){
      ContentValues values = new ContentValues();
                        ...
                        if(modelData.getDescription() != null){
                          ...
                          values.put("`description`", descriptionData);
                                                            ...
                                                            String onClickData = "";
                        if(modelData.getOnClick() != null){
                          GsonBuilder gsonBuilder = new GsonBuilder();
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                          onClickData = gson.toJson(modelData.getOnClick(), HashMap.class);
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final SnaphyNotification modelData ){
      new Thread(new Runnable(){
        @Override
        public void run(){
          SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
    ...
    public void update__db(final String id,   final SnaphyNotification modelData) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
