...
public class QrCodeGroupDb{
  ...
  public QrCodeGroupDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void insert__db (final String id, final QrCodeGroup _modelData) {
    ...
    public ContentValues getContentValues(QrCodeGroup _modelData){
      ContentValues values = new ContentValues();
                       
                                                            String group_numberData = "";
                        if(_modelData.getGroup_number() != null){
                          group_numberData = _modelData.getGroup_number().toString();
                        ...
                        total_generatedData = (double)_modelData.getTotal_generated();
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final QrCodeGroup _modelData ){
      new Thread(new Runnable(){
        @Override
        public void run(){
          SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
    ...
    public void update__db(final String id,   final QrCodeGroup _modelData) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
