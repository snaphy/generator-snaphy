...
public class BrandVerificationDb{
  ...
  public BrandVerificationDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<BrandVerification>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    public DataList<BrandVerification>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<BrandVerification> modelList = new DataList<BrandVerification>();
        String whereQuery = getWhereQuery(whereKeyValue);
        String selectQuery;
        if(orderBy != null){
            selectQuery = "SELECT  * FROM `BrandVerification` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM BrandVerification " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM BrandVerification " + whereQuery;
            }
        }
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `BrandVerification` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `BrandVerification` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `BrandVerification` " + whereQuery;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // updating row
                db.update("`BrandVerification`", values, "_DATA_UPDATED = 1 AND " + where, null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                db.beginTransaction();
                String where = getWhere(whereKeyValue);
                db.delete("`BrandVerification`", "_DATA_UPDATED = 0 AND " + where , null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void delete__db(final HashMap<String, Object> whereKeyValue) {
      new Thread(new Runnable() {
            ...
            public void run() {
                ...
                db.beginTransaction();
                String where = getWhere(whereKeyValue);
                db.delete("`BrandVerification`", where , null);
                db.setTransactionSuccessful();
                db.endTransaction();
            }
        }).start();
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final BrandVerification modelData ){
      new Thread(new Runnable(){
        @Override
        public void run(){
          SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
          ...
          ContentValues values = getContentValues(modelData);
          String where = getWhere(whereKeyValue);
          db.update("`BrandVerification`", values, where, null);
          db.setTransactionSuccessful();
          db.endTransaction();
          //db.close();
        }
