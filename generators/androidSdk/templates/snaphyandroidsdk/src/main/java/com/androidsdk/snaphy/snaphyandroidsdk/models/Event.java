...
public class Event extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      EventRepository lowercaseFirstLetterRepository = (EventRepository) getRepository();
			...
			try{
				//Adding database method for fetching from relation if not present..
		                if(school == null){
		                  ...
		                  RestAdapter restAdapter = eventRepository.getRestAdapter();
		                  if(restAdapter != null){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__school( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<School> callback) {
                                        ...
                                        //Define methods here..
                                        final EventRepository  eventRepo = restAdapter.createRepository(EventRepository.class);
                                        ...
                                        eventRepo.get__school( (String)that.getId(), refresh,  new ObjectCallback<School> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__admin( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Admin> callback) {
                                        ...
                                        eventRepo.get__admin( (String)that.getId(), refresh,  new ObjectCallback<Admin> (){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__teacher( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Teacher> callback) {
                                        ...
                                        eventRepo.get__teacher( (String)that.getId(), refresh,  new ObjectCallback<Teacher> (){
