...
public class IpdBed extends Model {
    ...
    public IpdBed (){
        that = this;
                ...
                /* Adding Getter and Setter methods */
                public boolean getIsBedOccupied(){
                    return isBedOccupied;
                }

                /* Adding Getter and Setter methods */
                public void setIsBedOccupied(boolean isBedOccupied){
                    this.isBedOccupied = isBedOccupied;
                    //Update hashMap value..
                    hashMap.put("isBedOccupied", isBedOccupied);
                }
