...
public class UserSetting extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      UserSettingRepository lowercaseFirstLetterRepository = (UserSettingRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(hospitalUser == null){
                                        UserSettingRepository userSettingRepository = (UserSettingRepository) getRepository();

                                        SnaphyRestAdapter restAdapter = userSettingRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__hospitalUser( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<HospitalUser> callback) {
                                        ...
                                        //Define methods here..
                                        final UserSettingRepository  userSettingRepo = restAdapter.createRepository(UserSettingRepository.class);
                                        ...
                                        userSettingRepo.get__hospitalUser( (String)that.getId(), refresh,  new ObjectCallback<HospitalUser> (){
