...
public class Subscriber extends Model {
    ...
    public Subscriber (){
        that = this;
                ...
                /* Adding Getter and Setter methods */
                public double getSubscriberId(){
                    return subscriberId;
                }

                /* Adding Getter and Setter methods */
                public void setSubscriberId(double subscriberId){
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      SubscriberRepository lowercaseFirstLetterRepository = (SubscriberRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public AppUser getAppUser() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(appUser == null){
                                        SubscriberRepository subscriberRepository = (SubscriberRepository) getRepository();

                                        SnaphyRestAdapter restAdapter = subscriberRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__appUser( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<AppUser> callback) {
                                        ...
                                        //Define methods here..
                                        final SubscriberRepository  subscriberRepo = restAdapter.createRepository(SubscriberRepository.class);
                                        ...
                                        subscriberRepo.get__appUser( (String)that.getId(), refresh,  new ObjectCallback<AppUser> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__chatRoom( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<ChatRoom> callback) {
                                        ...
                                        subscriberRepo.get__chatRoom( (String)that.getId(), refresh,  new ObjectCallback<ChatRoom> (){
