...
public class RecipeTagRepository extends ModelRepository<RecipeTag> {
    ...
    public RestContract createContract() {
        RestContract contract = super.createContract();
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "DEL"), "RecipeTag.deleteById");
                ...
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/change-stream", "POST"), "RecipeTag.createChangeStream");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "ALL"), "RecipeTag.getSchema");
            
        
            
                contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/save", "ALL"), "RecipeTag.save");
        ...
        return contract;
            ...
            public void prototype.updateAttributes(  String id,  HashMap<String, Object> data, final ObjectCallback<RecipeTag> callback){
