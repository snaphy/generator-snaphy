    ...
    public ContentValues getContentValues(Invoice _modelData){
      ContentValues values = new ContentValues();
                        ...
                        values.put("`invoiceNumber`", invoiceNumberData);
                                                            ...
                                                            String invoiceTermsData = "";
                        if(_modelData.getInvoiceTerms() != null){
                          invoiceTermsData = _modelData.getInvoiceTerms().toString();
                          values.put("`invoiceTerms`", invoiceTermsData);
                        }
                        ...
                        values.put("`gst`", gstData);
                                                            ...
                                                            double gstinNumberData;
                        gstinNumberData = (double)_modelData.getGstinNumber();
                        values.put("`gstinNumber`", gstinNumberData);
                                  
                                
                                                            double invoiceAmountData;
                        invoiceAmountData = (double)_modelData.getInvoiceAmount();
                        values.put("`invoiceAmount`", invoiceAmountData);
                        ...
                        if(_modelData.getInvoiceDate() != null){
                          ...
                          values.put("`invoiceDate`", invoiceDateData);
                                                            ...
                                                            String placeOfSupplyData = "";
                        if(_modelData.getPlaceOfSupply() != null){
                          placeOfSupplyData = _modelData.getPlaceOfSupply().toString();
                          values.put("`placeOfSupply`", placeOfSupplyData);
                        }
                                  
                                
                                                            String invoiceFromData = "";
                        if(_modelData.getInvoiceFrom() != null){
                          invoiceFromData = _modelData.getInvoiceFrom().toString();
                          values.put("`invoiceFrom`", invoiceFromData);
                        }
                                  
                                
                                                            String invoiceToData = "";
                        if(_modelData.getInvoiceTo() != null){
                          invoiceToData = _modelData.getInvoiceTo().toString();
                          values.put("`invoiceTo`", invoiceToData);
                        }
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(2) != null){
                          ...
                          invoiceNumberData = cursor.getInt(3);
                        ...
                        if(cursor.getString(4) != null){
                          invoiceTermsData = cursor.getString(4);
                          if(invoiceTermsData != null){
                            invoiceTermsData = (String)invoiceTermsData;
                            hashMap.put("invoiceTerms", invoiceTermsData);
                          }
                        }
                                                
                                
                                                            double gstData = (double)0;
                          gstData = cursor.getInt(5);
                          ...
                          hashMap.put("gst", gstData);
                                                            ...
                                                            double gstinNumberData = (double)0;
                          gstinNumberData = cursor.getInt(6);
                          gstinNumberData = (double)gstinNumberData;
                          hashMap.put("gstinNumber", gstinNumberData);


                                                
                                
                                                            double invoiceAmountData = (double)0;
                          invoiceAmountData = cursor.getInt(7);
                          invoiceAmountData = (double)invoiceAmountData;
                          hashMap.put("invoiceAmount", invoiceAmountData);
                        ...
                        if(cursor.getString(8) != null){
                          invoiceDateData = cursor.getString(8);
                        ...
                        if(cursor.getString(9) != null){
                          placeOfSupplyData = cursor.getString(9);
                          if(placeOfSupplyData != null){
                            placeOfSupplyData = (String)placeOfSupplyData;
                            hashMap.put("placeOfSupply", placeOfSupplyData);
                          }
                        }
                        ...
                        if(cursor.getString(10) != null){
                          invoiceFromData = cursor.getString(10);
                          if(invoiceFromData != null){
                            invoiceFromData = (String)invoiceFromData;
                            hashMap.put("invoiceFrom", invoiceFromData);
                          }
                        }
                        ...
                        if(cursor.getString(11) != null){
                          invoiceToData = cursor.getString(11);
                          if(invoiceToData != null){
                            invoiceToData = (String)invoiceToData;
                            hashMap.put("invoiceTo", invoiceToData);
                          }
                        }
