...
public class ProductSubCategory extends Model {
    ...
    private ProductSubCategory that ;
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      ProductSubCategoryRepository lowercaseFirstLetterRepository = (ProductSubCategoryRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Category getCategory() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(category == null){
                                        ProductSubCategoryRepository productSubCategoryRepository = (ProductSubCategoryRepository) getRepository();

                                        SnaphyRestAdapter restAdapter = productSubCategoryRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__category( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Category> callback) {
                                        ...
                                        //Define methods here..
                                        final ProductSubCategoryRepository  productSubCategoryRepo = restAdapter.createRepository(ProductSubCategoryRepository.class);
                                        ...
                                        productSubCategoryRepo.get__category( (String)that.getId(), refresh,  new ObjectCallback<Category> (){
