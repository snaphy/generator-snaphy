...
public class AreaRepository extends ModelRepository<Area> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers/:fk", "GET"), "Area.prototype.__findById__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers/:fk", "DELETE"), "Area.prototype.__destroyById__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers/:fk", "PUT"), "Area.prototype.__updateById__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers", "GET"), "Area.prototype.__get__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers", "POST"), "Area.prototype.__create__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers", "DELETE"), "Area.prototype.__delete__customers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/customers/count", "GET"), "Area.prototype.__count__customers");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void findById__customers(  String areaId,  String fk, final ObjectCallback<Customer> callback){
            ...
            public void destroyById__customers(  String areaId,  String fk, final VoidCallback callback){
            ...
            public void updateById__customers(  String areaId,  String fk,  Map<String,  ? extends Object> data, final ObjectCallback<Customer> callback){
            ...
            public void get__customers(  String areaId,  Map<String,  ? extends Object> filter, final DataListCallback<Customer> callback){
            ...
            public void create__customers(  String areaId,  Map<String,  ? extends Object> data, final ObjectCallback<Customer> callback){
            ...
            public void delete__customers(  String areaId, final VoidCallback callback){
            ...
            public void count__customers(  String areaId,  Map<String,  ? extends Object> where, final ObjectCallback<JSONObject>  callback ){
