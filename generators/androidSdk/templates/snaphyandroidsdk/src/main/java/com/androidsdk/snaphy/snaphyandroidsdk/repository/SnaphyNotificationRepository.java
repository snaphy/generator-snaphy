...
public class SnaphyNotificationRepository extends ModelRepository<SnaphyNotification> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/send", "POST"), "SnaphyNotification.send");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/changeStatus", "POST"), "SnaphyNotification.changeStatus");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            //Method send definition
            public void send(  Map<String,  ? extends Object> notificationData, final ObjectCallback<SnaphyNotification> callback){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("notificationData", notificationData);
                    ...
                    invokeStaticMethod("send", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method send definition ends here..
            ...
            //Method changeStatus definition
            public void changeStatus(  String notificationId,  String status, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("changeStatus", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method changeStatus definition ends here..
