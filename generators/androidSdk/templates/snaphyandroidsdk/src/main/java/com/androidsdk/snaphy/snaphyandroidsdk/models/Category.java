                    ...
                    */
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void connect__recipes( RestAdapter restAdapter, final Adapter.JsonObjectCallback  callback ) {
                                        ...
                                        categoryRepo.connect__recipes( (String)that.getId(),  (String)that.getFk(),  new Adapter.JsonObjectCallback(){
                                    ...
                                    public void disconnect__recipes( RestAdapter restAdapter, final Adapter.JsonObjectCallback  callback ) {
                                        ...
                                        categoryRepo.disconnect__recipes( (String)that.getId(),  (String)that.getFk(),  new Adapter.JsonObjectCallback(){
