...
public class Review extends Model {
    ...
    public Review (){
        that = this;
                ...
                public void setIsPublished(boolean isPublished){
                    ...
                    //Update hashMap value..
                    hashMap.put("isPublished", isPublished);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      ReviewRepository lowercaseFirstLetterRepository = (ReviewRepository) getRepository();
    ...
    //Now adding relations between related models
                        ...
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        ...
                                        SnaphyRestAdapter restAdapter = reviewRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final ReviewRepository  reviewRepo = restAdapter.createRepository(ReviewRepository.class);
                                        ...
                                        reviewRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__product( Boolean refresh,  SnaphyRestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        reviewRepo.get__product( (String)that.getId(), refresh,  new ObjectCallback<Product> (){
