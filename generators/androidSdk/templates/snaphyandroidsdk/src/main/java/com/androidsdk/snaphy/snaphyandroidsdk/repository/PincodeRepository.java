...
public class PincodeRepository extends ModelRepository<Pincode> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/searchPincode", "POST"), "Pincode.searchPincode");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            //Method searchPincode definition
            public void searchPincode(  double searchPin, final DataListCallback<Pincode> callback){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("searchPin", searchPin);
                    ...
                    invokeStaticMethod("searchPincode", hashMapObject, new Adapter.JsonArrayCallback() {
                        @Override
                        public void onError(Throwable t) {
                            callback.onError(t);
                            //Call the finally method..
            ...
            }//Method searchPincode definition ends here..
