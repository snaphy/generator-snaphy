...
public class AppUserDb{
  ...
  public AppUserDb(Context context, String DATABASE_NAME, SnaphyRestAdapter restAdapter){
    ...
    public void insert__db (final String id, final AppUser _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      // Inserting Row
    ...
    public ContentValues getContentValues(AppUser _modelData){
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(5) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           profilePicData = gson.fromJson(cursor.getString(5), Map.class);
                        ...
                        if(cursor.getString(8) != null){
                          oriUserIdData = cursor.getString(8);
                          ...
                          cricUserIdData = cursor.getInt(9);
     ...
     * @return
     */
    public LazyList<AppUser> getAll__lazy(final int limit, final int skip, ObjectCallback<AppUser> callback, final GetUpdatedQuery getUpdatedQuery, final OnParseCursor onParseCursor) {


        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();

        final AppUserRepository repo = restAdapter.createRepository(AppUserRepository.class);
        repo.addStorage(context);
        return new LazyList<>(db, new LazyList.ItemFactory<AppUser>() {
            @Override
            public AppUser create(Cursor cursor, int index) {
                AppUser data;
                cursor.moveToPosition(index);
                HashMap<String, Object> hashMap = onParseCursor.parseCursor(cursor);
                data = (AppUser)repo.createObject(hashMap);
                return data;
            }
            ...
            public String getUpdateQuery() {
                ...
                String selectQuery;
                if(orderBy != null){
                    selectQuery = "SELECT  * FROM `AppUser` " + whereQuery  + " ORDER BY " + orderBy ;
                    if(limit != 0){
                        // Select All Query
                    ...
                    if(limit != 0){
                        // Select All Query
                        selectQuery = "SELECT  * FROM AppUser " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
                    }else{
                        selectQuery = "SELECT  * FROM AppUser " + whereQuery  + " LIMIT -1 OFFSET " + skip;
                    }
                }
    ...
    public AppUser get__db(String id, OnParseCursor onParseCursor){
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("AppUser", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
    ...
    public DataList<AppUser>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    // Getting All Data where and sort column according to date wise..
    public DataList<AppUser>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<AppUser> modelList = new DataList<AppUser>();
    ...
    // Getting All Data where
    public DataList<AppUser>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `AppUser` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `AppUser` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `AppUser` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
            ...
            // updating row
            db.update("`AppUser`", values, "_DATA_UPDATED = 1 AND " + where, null);
    }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`AppUser`", "_DATA_UPDATED = 0 AND " + where , null);
    }
    ...
    public void deleteOldData__db(final String whereKey, final String whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`AppUser`", "_DATA_UPDATED = 0 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }


    //Update multiple data at once..
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final AppUser _modelData ){
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
      db.update("`AppUser`", values, where, null);
    }
    ...
    public void update__db(final String id,   final AppUser _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`AppUser`", values, "id = ?", new String[] { id });
    }
