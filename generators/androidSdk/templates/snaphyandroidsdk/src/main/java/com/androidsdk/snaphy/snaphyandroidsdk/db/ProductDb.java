...
public class ProductDb{
  ...
  public ProductDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(0) != null){
                          product_numberData = cursor.getString(0);
                          if(product_numberData != null){
                            product_numberData = (String)product_numberData;
                            hashMap.put("product_number", product_numberData);
                          }
                        }
                        ...
                        if(cursor.getString(2) != null){
                          product_codeData = cursor.getString(2);
                          if(product_codeData != null){
                            product_codeData = (String)product_codeData;
                            hashMap.put("product_code", product_codeData);
                          }
                        }
                                                
                                
                                                            double priceData = (double)0;
                          priceData = cursor.getInt(3);
                        ...
                        if(cursor.getString(4) != null){
                          commentsData = cursor.getString(4);
    ...
    public DataList<Product>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Product> modelList = new DataList<Product>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Product " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Product " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Product>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Product` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `Product` " + whereQuery;
            }
        }
