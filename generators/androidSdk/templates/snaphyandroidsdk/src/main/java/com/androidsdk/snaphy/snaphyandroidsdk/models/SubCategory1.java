...
public class SubCategory1 extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      SubCategory1Repository lowercaseFirstLetterRepository = (SubCategory1Repository) getRepository();
                        ...
                        //Check for pure case of hasMany
                          ...
                          try{
                            ...
                            if(that.getId() != null && productRepository.getDb() != null){
                                 ...
                                 // Getting single cont
                                 products = productRepository.getDb().getAll__db("subCategory1Id", that.getId().toString());
                ...
                */
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void findById__products( String fk,  RestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        //Define methods here..
                                        final SubCategory1Repository  subCategory1Repo = restAdapter.createRepository(SubCategory1Repository.class);
                                        ...
                                        subCategory1Repo.findById__products( (String)that.getId(), fk,  new ObjectCallback<Product> (){
                                    ...
                                    public void destroyById__products( String fk,  RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        subCategory1Repo.destroyById__products( (String)that.getId(), fk,  new VoidCallback (){
                                    ...
                                    public void updateById__products( String fk,  Product data,  RestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        subCategory1Repo.updateById__products( (String)that.getId(), fk, data.convertMap(),  new ObjectCallback<Product> (){
                                    ...
                                    public void get__products( Map<String,  ? extends Object> filter,  RestAdapter restAdapter, final DataListCallback<Product> callback) {
                                        ...
                                        subCategory1Repo.get__products( (String)that.getId(), filter,  new DataListCallback<Product> (){
                                    ...
                                    public void create__products( Product data,  RestAdapter restAdapter, final ObjectCallback<Product> callback) {
                                        ...
                                        subCategory1Repo.create__products( (String)that.getId(), data.convertMap(),  new ObjectCallback<Product> (){
                                    ...
                                    public void delete__products( RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        subCategory1Repo.delete__products( (String)that.getId(),  new VoidCallback (){
                                    ...
                                    public void count__products( Map<String,  ? extends Object> where,  RestAdapter restAdapter, final ObjectCallback<JSONObject>  callback) {
                                        ...
                                        subCategory1Repo.count__products( (String)that.getId(), where,  new ObjectCallback<JSONObject>(){
