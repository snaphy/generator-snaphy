...
public class PincodeDb{
  ...
  public PincodeDb(Context context, String DATABASE_NAME, SnaphyRestAdapter restAdapter){
    ...
    public void insert__db (final String id, final Pincode _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      // Inserting Row
      ContentValues values = getContentValues(_modelData);
      db.insert("`Pincode`", null, values);
    }
    ...
    public ContentValues getContentValues(Pincode _modelData){
      ContentValues values = new ContentValues();
                       
                                                            String numberData = "";
                        if(_modelData.getNumber() != null){
                          numberData = _modelData.getNumber().toString();
                        ...
                        if(_modelData.getAdded() != null){
                          ...
                          values.put("`added`", addedData);
                                                            ...
                                                            String districtNameData = "";
                        if(_modelData.getDistrictName() != null){
                          districtNameData = _modelData.getDistrictName().toString();
                          values.put("`districtName`", districtNameData);
                        }
                                  
                                
                                                            String talukNameData = "";
                        if(_modelData.getTalukName() != null){
                          talukNameData = _modelData.getTalukName().toString();
                          values.put("`talukName`", talukNameData);
                        }
    ...
    // Getting single c
    public   Pincode get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Pincode", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    if (hashMap != null) {
                        PincodeRepository repo = restAdapter.createRepository(PincodeRepository.class);
                        repo.addStorage(context);
                        return (Pincode)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   Pincode get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("`Pincode`", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(0) != null){
                          numberData = cursor.getString(0);
                          if(numberData != null){
                            numberData = (String)numberData;
                        ...
                        if(cursor.getString(2) != null){
                          districtNameData = cursor.getString(2);
                          if(districtNameData != null){
                            districtNameData = (String)districtNameData;
                            hashMap.put("districtName", districtNameData);
                          }
                        }
                        ...
                        if(cursor.getString(3) != null){
                          talukNameData = cursor.getString(3);
                          if(talukNameData != null){
                            talukNameData = (String)talukNameData;
                            hashMap.put("talukName", talukNameData);
                          }
                        }
                        ...
                        if(cursor.getString(6) != null){
                          stateIdData = cursor.getString(6);
                          if(stateIdData != null){
                        ...
                        if(cursor.getString(7) != null){
                          talukIdData = cursor.getString(7);
                          if(talukIdData != null){
                        ...
                        if(cursor.getString(8) != null){
                          districtIdData = cursor.getString(8);
    ...
    public void upsert__db(String id, Pincode model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<Pincode>  getAll__db() {
        DataList<Pincode> modelList = new DataList<Pincode>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `Pincode`";
        ...
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            ...
            do {
                ...
                if(hashMap != null){
                    PincodeRepository repo = restAdapter.createRepository(PincodeRepository.class);
                    repo.addStorage(context);
                    modelList.add((Pincode)repo.createObject(hashMap));
                }
    ...
    public Pincode get__db(String id, OnParseCursor onParseCursor){
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Pincode", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
    ...
    public DataList<Pincode>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    // Getting All Data where and sort column according to date wise..
    public DataList<Pincode>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<Pincode> modelList = new DataList<Pincode>();
    ...
    // Getting All Data where
    public DataList<Pincode>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `Pincode` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
            ...
            // updating row
            db.update("`Pincode`", values, "_DATA_UPDATED = 1 AND " + where, null);
    }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`Pincode`", "_DATA_UPDATED = 0 AND " + where , null);
    }
    ...
    // Getting All Data where
    public DataList<Pincode>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<Pincode> modelList = new DataList<Pincode>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `Pincode` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
    ...
    public int count__db(String whereKey, String whereKeyValue){
      String countQuery = "SELECT  * FROM `Pincode` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
      Cursor cursor = db.rawQuery(countQuery, null);
      int count = cursor.getCount();
      cursor.close();
    ...
    public void checkOldData__db(final String whereKey, final String whereKeyValue) {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`Pincode`", values, "_DATA_UPDATED = 1 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }
    ...
    public void deleteOldData__db(final String whereKey, final String whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`Pincode`", "_DATA_UPDATED = 0 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }


    //Update multiple data at once..
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final Pincode _modelData ){
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
      db.update("`Pincode`", values, where, null);
    }
    ...
    public void update__db(final String id,   final Pincode _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`Pincode`", values, "id = ?", new String[] { id });
    }
    ...
    public void checkOldData__db() {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`Pincode`", values, "_DATA_UPDATED = 1", null);
    }
    ...
    public void deleteOldData__db() {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`Pincode`", "_DATA_UPDATED = 0", null);
    }
