...
public class CommentDb{
  ...
  public CommentDb(Context context, String DATABASE_NAME, SnaphyRestAdapter restAdapter){
    ...
    public void insert__db (final String id, final Comment _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      // Inserting Row
    ...
    public ContentValues getContentValues(Comment _modelData){
      ContentValues values = new ContentValues();
                        ...
                        if(_modelData.getStatus() != null){
                          ...
                          values.put("`status`", statusData);
                                                            ...
                                                            double totalResponsesData;
                        totalResponsesData = (double)_modelData.getTotalResponses();
                        values.put("`totalResponses`", totalResponsesData);
                        ...
                        if(_modelData.getUpdated() != null){
                          ...
                          values.put("`updated`", updatedData);
                                                            ...
                                                            double commentorIdData;
                        commentorIdData = (double)_modelData.getCommentorId();
                        values.put("`commentorId`", commentorIdData);
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(3) != null){
                          ...
                          if(statusData != null){
                            ...
                            hashMap.put("status", statusData);
                                                            ...
                                                            double totalResponsesData = (double)0;
                          totalResponsesData = cursor.getInt(4);
                          totalResponsesData = (double)totalResponsesData;
                          hashMap.put("totalResponses", totalResponsesData);
                        ...
                        if(cursor.getString(6) != null){
                          ...
                          if(updatedData != null){
                            ...
                            hashMap.put("updated", updatedData);
                                                            ...
                                                            double commentorIdData = (double)0;
                          commentorIdData = cursor.getInt(7);
                          commentorIdData = (double)commentorIdData;
                          hashMap.put("commentorId", commentorIdData);
                        ...
                        if(cursor.getString(11) != null){
                          postIdData = cursor.getString(11);
                          if(postIdData != null){
     ...
     * @return
     */
    public LazyList<Comment> getAll__lazy(final int limit, final int skip, ObjectCallback<Comment> callback, final GetUpdatedQuery getUpdatedQuery, final OnParseCursor onParseCursor) {


        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();

        final CommentRepository repo = restAdapter.createRepository(CommentRepository.class);
        repo.addStorage(context);
        return new LazyList<>(db, new LazyList.ItemFactory<Comment>() {
            @Override
            public Comment create(Cursor cursor, int index) {
                Comment data;
                cursor.moveToPosition(index);
                HashMap<String, Object> hashMap = onParseCursor.parseCursor(cursor);
                data = (Comment)repo.createObject(hashMap);
                return data;
            }
            ...
            public String getUpdateQuery() {
                ...
                if(orderBy != null){
                    ...
                    if(limit != 0){
                        // Select All Query
                        selectQuery = "SELECT  * FROM Comment " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
                    }else{
                        selectQuery = "SELECT  * FROM Comment " + whereQuery  + " LIMIT -1 OFFSET " + skip;
                    }
                }
    ...
    public Comment get__db(String id, OnParseCursor onParseCursor){
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Comment", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
    ...
    // Getting All Data where and sort column according to date wise..
    public DataList<Comment>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<Comment> modelList = new DataList<Comment>();
    ...
    // Getting All Data where
    public DataList<Comment>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Comment` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `Comment` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final Comment _modelData ){
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
    ...
    public void update__db(final String id,   final Comment _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`Comment`", values, "id = ?", new String[] { id });
    }
