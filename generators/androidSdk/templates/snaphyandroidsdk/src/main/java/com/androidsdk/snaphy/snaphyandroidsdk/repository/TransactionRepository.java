...
public class TransactionRepository extends ModelRepository<Transaction> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:transactionId/customer", "GET"), "Transaction.prototype.__get__customer");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void get__customer(  String transactionId,  Boolean refresh, final ObjectCallback<Customer> callback){
