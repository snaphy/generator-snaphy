...
public class GuestDb{
  ...
  public GuestDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void insert__db (final String id, final Guest modelData) {
    ...
    public ContentValues getContentValues(Guest modelData){
    ...
    // Getting single c
    public   Guest get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Guest", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    //db.close(); // Closing database connection
                    if (hashMap != null) {
                        GuestRepository repo = restAdapter.createRepository(GuestRepository.class);
                        repo.addStorage(context);
                        return (Guest)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   Guest get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Guest", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(3) != null){
                          credentialsData = cursor.getString(3);
                        ...
                        if(cursor.getString(4) != null){
                          challengesData = cursor.getString(4);
                        ...
                        if(cursor.getString(6) != null){
                          emailVerifiedData = cursor.getString(6);
                        ...
                        if(cursor.getString(7) != null){
                          verificationTokenData = cursor.getString(7);
                        ...
                        if(cursor.getString(9) != null){
                          createdData = cursor.getString(9);
                          if(createdData != null){
                        ...
                        if(cursor.getString(10) != null){
                          lastUpdatedData = cursor.getString(10);
                        ...
                        if(cursor.getString(12) != null){
                          schoolIdData = cursor.getString(12);
    ...
    public void upsert__db(String id, Guest model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<Guest>  getAll__db() {
        DataList<Guest> modelList = new DataList<Guest>();
        // Select All Query
        ...
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            return (DataList<Guest>) modelList;
        }else{
            do {
                ...
                if(hashMap != null){
                    GuestRepository repo = restAdapter.createRepository(GuestRepository.class);
                    repo.addStorage(context);
                    modelList.add((Guest)repo.createObject(hashMap));
                }
    ...
    public DataList<Guest>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    public DataList<Guest>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Guest> modelList = new DataList<Guest>();
        String whereQuery = getWhereQuery(whereKeyValue);
        String selectQuery;
        if(orderBy != null){
            selectQuery = "SELECT  * FROM Guest " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Guest " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Guest " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Guest>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM Guest " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM Guest " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM Guest " + whereQuery;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // updating row
                db.update("Guest", values, "_DATA_UPDATED = 1 AND " + where, null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                db.beginTransaction();
                String where = getWhere(whereKeyValue);
                db.delete("Guest", "_DATA_UPDATED = 0 AND " + where , null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    // Getting All Data where
    public DataList<Guest>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<Guest> modelList = new DataList<Guest>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `Guest` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
    ...
    public int count__db(String whereKey, String whereKeyValue){
        String countQuery = "SELECT  * FROM `Guest` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
        Cursor cursor = db.rawQuery(countQuery, null);
        int count = cursor.getCount();
        cursor.close();
    ...
    public void checkOldData__db(final String whereKey, final String whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                values.put("_DATA_UPDATED", 0);
                // updating row
                db.update("Guest", values, "_DATA_UPDATED = 1 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db(final String whereKey, final String whereKeyValue) {
        new Thread(new Runnable() {
            ...
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
                db.beginTransaction();
                db.delete("Guest", "_DATA_UPDATED = 0 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void update__db(final String id,   final Guest modelData) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
    ...
    public void checkOldData__db() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                values.put("_DATA_UPDATED", 0);
                // updating row
                db.update("Guest", values, "_DATA_UPDATED = 1", null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
    ...
    public void deleteOldData__db() {
      new Thread(new Runnable() {
            ...
            public void run() {
                SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
                db.beginTransaction();
                db.delete("Guest", "_DATA_UPDATED = 0", null);
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
            }
