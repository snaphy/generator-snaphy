...
public class CustomEvent extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      CustomEventRepository lowercaseFirstLetterRepository = (CustomEventRepository) getRepository();
			...
			try{
				//Adding database method for fetching from relation if not present..
		                if(school == null){
		                  ...
		                  RestAdapter restAdapter = customEventRepository.getRestAdapter();
		                  if(restAdapter != null){
				...
				return null;
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__school( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<School> callback) {
                                        ...
                                        //Define methods here..
                                        final CustomEventRepository  customEventRepo = restAdapter.createRepository(CustomEventRepository.class);
                                        ...
                                        customEventRepo.get__school( (String)that.getId(), refresh,  new ObjectCallback<School> (){
